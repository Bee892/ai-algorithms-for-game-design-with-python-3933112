...
class CatTrapGame:
    ...
    def max_value(self, depth):
        ...
        2) Search for all "TODO:" comments below inside max_value() and min_value().
        3) Fill in the blanks following the instructions in the "TODO:" comments.
        4) Replicate those additions in alpha_beta_max_value() and 
           alpha_beta_min_value() below. 
        5) If you're stuck, you may ask in the course's Q&A or consult the
